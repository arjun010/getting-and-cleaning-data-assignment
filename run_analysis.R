...
# Returns a temporary dataframe for a single dataset.
...
# Primary function performing the required analysis
...
# Call to the function performing analysis. The parameter passed is the folder in which the data(in this case the Samsung mobile data) is stored.
run.analysis("C:\\Users\\arjun010\\Desktop\\Assignment\\data")